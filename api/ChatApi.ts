...
const CHAT_PLAN: RegisterPlanParams = {
    id: 'ChatPlan',
    name: 'Chat Plan',
...
const TOPIC_PLAN: RegisterPlanParams = {
    id: 'TopicPlan',
    name: 'Topic Plan',
...
export class ChatApi {
    ...
    async init(): Promise<void> {
        this.chatPlanIdHash = await this.storyFactory.registerPlan(CHAT_PLAN);
        this.topicPlanIdHash = await this.storyFactory.registerPlan(TOPIC_PLAN);
    }
