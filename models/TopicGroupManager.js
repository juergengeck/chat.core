        ...
        return async (hash, type) => {
            if (type === 'Group') {
                try {
                    ...
                    const group = await getIdObject(hash);
                    const hashGroup = await getIdObject(group.hashGroup);
                    ...
                    for (const signature of signatures) {
                        ...
                        const profile = await this.oneCore.leuteModel.getMainProfile(signature.issuer);
