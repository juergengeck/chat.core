 ...
 */
export async function grantP2PChannelAccess(person1: any, person2: any, channelManager: any): Promise<any> {
 ...
 * @param {Object} channelManager - The ChannelManager instance
 */
export async function handleP2PChannelCreation(topicId: any, leuteModel: any, channelManager: any): Promise<any> {
