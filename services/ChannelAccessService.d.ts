 ...
 */
export declare function grantMutualChannelAccess(participantsHash: SHA256Hash<HashGroup<Person>>, person1Id: SHA256IdHash<Person>, person2Id: SHA256IdHash<Person>, discriminator?: string): Promise<boolean>;
/**
