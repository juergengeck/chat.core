        ...
        try {
            ...
            for (const someone of someoneObjects) {
                try {
                    ...
                    // If no PersonName found, get email from Person object (email is the ID)
                    if (!displayName) {
                        ...
                        if (person && person.email) {
                            ...
                            throw new Error(`Person ${String(personId).substring(0, 8)} has no email - this should never happen`);
                        }
                    }
