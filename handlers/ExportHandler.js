...
export class ExportHandler {
    ...
    htmlTemplate;
    messageRetriever;
    constructor(implodeWrapper, formatter, htmlTemplate, messageRetriever) {
     ...
     */
    validateExportRequest({ topicId, format, options = {} }) {
        // Validate topicId
     ...
     */
    async getMessagesFromTopic(topicId, options) {
     ...
     */
    async processMessagesWithImplode(messages, options) {
     ...
     */
    async generateMetadata(topicId, messages, options) {
     ...
     */
    generateEmptyConversationHTML(topicId, options) {
